...
parser <- add_argument(parser, "--workdir", help = "The directory within which to run the R process", default = "/scratch/users/lanhuong/Projects/PerturbationStudy/perturbation_16s/metagenomics")
