...
```{r metat-vs-16s, fig.width=10, fig.height=10}
...
```{r tsne-subj-org-metat, fig.width=10, fig.height=8}
...
```{r tsne-subj-org-metat-abx, fig.width=10, fig.height=8}
library(viridis)
(plt <- ggplot(
  scores_df %>%
...
```{r tsne-subj-org-metat-time-diet, fig.width=10, fig.height=8}
(plt <- ggplot(
  scores_df %>%
...
```{r pca-subj-org-metat, fig.width=10, fig.height=8}
...
```{r pca-subj-org-metat-diet, fig.width=10, fig.height=8}
var.explained <- round(eigs_pca$var_exp, 2)
(plt <- ggplot(
  scores_pca_df %>%
...
```{r pca-subj-org-metat-abx, fig.width=10, fig.height=8}
var.explained <- round(eigs_pca$var_exp, 2)
(plt <- ggplot(
  scores_pca_df %>%
...
```{r tsne-subj-fun-metat, fig.width=10, fig.height=8}
(plt <- ggplot(scores_df, aes(Axis1, Axis2)) +
  geom_text(
    aes(label = Subject, color = Subject), size = 5) +
   scale_color_brewer(palette = "Set1") +
...
```{r tsne-subj-fun-metat-abx, fig.width=10, fig.height=8}
library(viridis)
(plt <- ggplot(
  scores_df %>%
    mutate(Abx_RelDay = as.numeric(Abx_RelDay)),
...
```{r pca-subj-fun-metat, fig.width=10, fig.height=8}
var.explained <- round(eigs_pca$var_exp, 2)
(plt <- ggplot(scores_pca_df, aes(Axis1, Axis2)) +
   geom_text(
    aes(label = Subject, color = Subject), 
...
```{r pca-subj-fun-metat-diet, fig.width=10, fig.height=8}
var.explained <- round(eigs_pca$var_exp, 2)
(plt <- ggplot(
  scores_pca_df %>%
    mutate(Diet_RelDay = as.numeric(Diet_RelDay)), aes(Axis1, Axis2)) +
...
```{r pca-subj-fun-metat-abx, fig.width=10, fig.height=8}
var.explained <- round(eigs_pca$var_exp, 2)
(plt <- ggplot(
  scores_pca_df %>%
    mutate(Abx_RelDay = as.numeric(Abx_RelDay)), aes(Axis1, Axis2)) +
