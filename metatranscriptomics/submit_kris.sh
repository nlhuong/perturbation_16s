...
export SUBDIR=Relman_RNAseq_21
...
export OUT=${2:-$PI_BASE_DIR/processed/kris_test/$SUBDIR}
export FWD=${3:-M3888_EAQsw_1r_ATTACTCG-AGGCTATA_L007_R1_001.fastq}
export REV=${4:-M3888_EAQsw_1r_ATTACTCG-AGGCTATA_L007_R2_001.fastq}
