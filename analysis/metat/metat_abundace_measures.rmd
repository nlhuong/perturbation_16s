...
```{r}
file <- "final_results/abund_refseq_len_ratio.csv"
metat <- fread(file.path(datadir, file))
...
```{r}
ps <- readRDS("/scratch/PI/sph/resilience/16S/phyloseq/perturb_physeq_22Jan18.rds")
```
