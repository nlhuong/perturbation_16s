---
title: "Combining 16S and Metabolon Data_new"
author: 
...
```{r}
ps_subset <- readRDS("/Users/visitor/Google Drive/Studium/Master/MoBi/4. Semester/Praktikum Stanford/Praktikumsunterlagen/Stanford-Internship/Metabolon Data/Multitable Analysis with Microbiome/data folder Lan GoogleDrive/data/16_rds/ps16S_asinh_matched_with_metabolon_25mar2019.rds")
...
```{r SR}
metabolome <- readRDS("/Users/visitor/Google Drive/Studium/Master/MoBi/4. Semester/Praktikum Stanford/Praktikumsunterlagen/Stanford-Internship/Metabolon Data/Multitable Analysis with Microbiome/data folder Lan GoogleDrive/data/metabolome_rds/assayData NA_filtered_and_imputed.rds")
...
brayDist <- phyloseq::distance(ps_subset, method="bray")
...
```{r}
#calculate correlation between the two distances
correlation_metabol_16S_distance <- cor(distDF$value.bray, distDF$value.metabol)
correlation_metabol_16S_distance
```


```{r}

write.csv(sample_data(ps_subset), "ps_subset_sample_data")
ps_subset_sample_data <- read_csv("ps_subset_sample_data")

distDF <- distDF %>%
    left_join(ps_subset_sample_data %>% 
