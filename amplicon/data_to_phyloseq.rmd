...
```{r}
minSampleSums <- 5000
ps1 <- prune_samples(colnames(ps@otu_table)[colSums(ps@otu_table) >= minSampleSums], ps)
ps1
```
...
```{r}
saveRDS(ps1, file.path(path_to_process_data, "perturb_physeq_filtered_14Dec.rds"))
```
